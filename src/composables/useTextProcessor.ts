  ...
  if (typeof obj1 === 'object' && obj1 !== null && typeof obj2 === 'object' && obj2 !== null) {
    ...
    for (const key of allKeys) {
      ...
      if (!(key in obj1Record)) {
        differences.push({ path: newPath, type: 'missing_in_first', value2: obj2Record[key] })
      } else if (!(key in obj2Record)) {
        differences.push({ path: newPath, type: 'missing_in_second', value1: obj1Record[key] })
      } else {
        differences.push(...compareJSONObjects(obj1Record[key], obj2Record[key], newPath))
      }
    }
    return differences
  }
